...
/* 
*  基于vue-server-renderer/client-plugin 修改
*  添加了一个clientManifestPath设置项，打包一个clientManifest到这个位置
*/
...
VueSSRClientPlugin.prototype.apply = function apply (compiler) {
  ...
  compiler.plugin('emit', function (compilation, cb) {
    ...
    // 添加功能，发布一份clientManifest到指定目录下
    if (this$1.options.clientManifestPath) {
      var fs = require('fs');
      var path = require('path');
      fs.writeFileSync(path.join(this$1.options.clientManifestPath, this$1.options.filename), json, {
        encoding: 'utf8'
      });
    }
